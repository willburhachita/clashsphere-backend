...
urlpatterns = [
    ...
    path('api/battle/', include(('battle.urls', 'battle'), namespace='battle_management')),
    path('api/chat/', include(('chat.urls', 'chat'), namespace='chat_management')),
    path('api/notifications/', include(('notifications.urls', 'notifications'), namespace='notification_management')),
    path('api/transactions/', include(('transactions.urls', 'transactions'), namespace='transaction_management')),
